...
public class Informes extends javax.swing.JFrame {
        ...
        try {
            ...
            while(rs.next() && rs2.next()){
                if(rs2.getString("EST_VEN_ESTADO").contentEquals("Activo")){
                    if(rs.getString("EST_VEN_NOMBRE").contentEquals("Recibido") || rs.getString("EST_VEN_NOMBRE").contentEquals("No Encontrado") || rs.getString("EST_VEN_NOMBRE").contentEquals("Anulado") || rs.getString("EST_VEN_NOMBRE").contentEquals("Rechazado")){
    ...
    private void initComponents() {
        ...
        TabbedPane_VENTAS.addTab("Informe Ventas", jPanel3);
        ...
        TabbedPane_VENTAS.addTab("Informe Inventario", jPanel1);
        ...
        TabbedPane_VENTAS.addTab("Informe Cliente", jPanel4);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("Actualización Estado Despacho");

        txt_Buscar_Actualizacion_Despacho.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_Buscar_Actualizacion_DespachoActionPerformed(evt);
            }
        });
        ...
        TabbedPane_VENTAS.addTab("Informe Dev. & Cambios", jPanel5);
    ...
    private void txt_Buscar_Actualizacion_DespachoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_Buscar_Actualizacion_DespachoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_Buscar_Actualizacion_DespachoActionPerformed
